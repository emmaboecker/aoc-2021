fn main() {
    ...
    for i in 0..length {
        ...
        oxygen_generator = retained_respectively(oxygen_generator, i, true);
        co2_scrubber = retained_respectively(co2_scrubber, i, false);
    }
...
fn retained_respectively(lines: Vec<&str>, index: usize, most_common: bool) -> Vec<&str> {
    if lines.len() == 1 {
        return lines;
    }
